...
app.config(['$routeProvider', '$locationProvider',
        ...
        $routeProvider.when('/', {templateUrl: 'voter-list.html', controller: 'UserListCtrl'})
        .when('/voter/:id', {templateUrl: 'voter.html', controller: 'UserDetailCtrl'})
        .when('/create-vote', {templateUrl: 'create-vote.html'});
